    ...
    public static class MapGeometryGltfExtensions
    {
        ...
        private static readonly Dictionary<uint, IMaterialAdapter> MATERIAL_ADAPTERS =
            new()
            {
                ...
                // ------------- RENAMED ENV SHADERS -------------
                { Fnv1a.HashLower("Shaders/StaticMesh/DefaultEnv"), new DefaultEnv() },
                { Fnv1a.HashLower("Shaders/StaticMesh/DefaultEnv_Flat"), new DefaultEnvFlat() },
                { Fnv1a.HashLower("Shaders/StaticMesh/DefaultEnv_Flat_AlphaTest"), new DefaultEnvFlatAlphaTest() },
                {
                    Fnv1a.HashLower("Shaders/StaticMesh/DefaultEnv_Flat_AlphaTest_DoubleSided"),
                    new DefaultEnvFlatAlphaTestDoubleSided()
                },
                { Fnv1a.HashLower("Shaders/StaticMesh/SRX_Blend_Chemtech_Decal"), new SrxBlendChemtechDecal() },
                { Fnv1a.HashLower("Shaders/StaticMesh/SRX_Blend_Chemtech_Ground"), new SrxBlendChemtechGround() },
                { Fnv1a.HashLower("Shaders/StaticMesh/SRX_Blend_Cloud_Ground"), new SrxBlendCloudGround() },
                { Fnv1a.HashLower("Shaders/StaticMesh/SRX_Blend_Cloud_WindZone"), new SrxBlendCloudWindZone() },
                { Fnv1a.HashLower("Shaders/StaticMesh/SRX_Blend_Earth_Ground"), new SrxBlendEarthGround() },
                { Fnv1a.HashLower("Shaders/StaticMesh/SRX_Blend_Earth_Island"), new SrxBlendEarthIsland() },
                { Fnv1a.HashLower("Shaders/StaticMesh/SRX_Blend_Earth_Rocks"), new SrxBlendEarthRocks() },
                { Fnv1a.HashLower("Shaders/StaticMesh/SRX_Blend_Generic_Island"), new SrxBlendGenericIsland() },
                { Fnv1a.HashLower("Shaders/StaticMesh/SRX_Blend_Hextech_Dragon"), new SrxBlendHextechDragon() },
                { Fnv1a.HashLower("Shaders/StaticMesh/SRX_Blend_Hextech_Ground"), new SrxBlendHextechGround() },
                { Fnv1a.HashLower("Shaders/StaticMesh/SRX_Blend_Hextech_Island"), new SrxBlendHextechIsland() },
                { Fnv1a.HashLower("Shaders/StaticMesh/SRX_Blend_Infernal_Dragon"), new SrxBlendInfernalDragon() },
                { Fnv1a.HashLower("Shaders/StaticMesh/SRX_Blend_Infernal_Ground"), new SrxBlendInfernalGround() },
                { Fnv1a.HashLower("Shaders/StaticMesh/SRX_Blend_Infernal_Island"), new SrxBlendInfernalIsland() },
                { Fnv1a.HashLower("Shaders/StaticMesh/SRX_Blend_Master"), new SrxBlendMaster() },
                { Fnv1a.HashLower("Shaders/StaticMesh/SRX_Blend_Ocean"), new SrxBlendOcean() },
                { Fnv1a.HashLower("Shaders/StaticMesh/SRX_Brush"), new SrxBrush() },
                { Fnv1a.HashLower("Shaders/StaticMesh/OD_FlowMap"), new OdFlowMap() },
                // ------------- RENAMED ENV SHADERS -------------
